  ...
  <aside className="sidebar" aria-label="Sidebar">
    ...
    <section className="sidebar__social-media">
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '1rem' }}>
        <img src={logo} alt="Sarkari Exam Logo" style={{ width: '100px', height: '100px', borderRadius: '50%' }} />
      </div>
      <ul className="sidebar__list">
        <li className="sidebar__item">
          <a className="sidebar__link" href="https://t.me/" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
            {/* Telegram Icon */}
        ...
        <li className="sidebar__item">
          <a className="sidebar__link" href="https://wa.me/" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
            {/* WhatsApp Icon */}
        ...
        <li className="sidebar__item">
          <a className="sidebar__link" href="https://twitter.com/" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
            {/* Twitter Icon */}
        ...
        <li className="sidebar__item">
          <a className="sidebar__link" href="https://instagram.com/" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
            {/* Instagram Icon */}
